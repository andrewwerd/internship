    ...
    static class Program
    {
        static void Main(string[] args)
        {
            ...
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                ...
                var sqlCommandText2 = "IF OBJECT_ID(N'Orders', N'U') IS NULL CREATE TABLE Orders(OrderId int not null identity(1,1) primary key, OrderName NVARCHAR(40), Price decimal not null, Quantity int not null, CustomerId int foreign key references Customers(CustomerId))";
            ...
            using (var sqlConnection = new SqlConnection(connectionString))
            {
                var customersDataAdapter = CustomerDataAdapter(sqlConnection);
                var ordersDataAdapter = OrderDataAdapter(sqlConnection);
        ...
        public static SqlDataAdapter CustomerDataAdapter(SqlConnection sqlConnection)
        {
            ...
            //InsertComand
            var insertText = "INSERT INTO Customers(First_Name, Last_Name) VALUES(@First_Name, @Last_Name)";
            ...
            SqlParameter parameter = command.Parameters.Add("@CustomerId", SqlDbType.BigInt,sizeof(long),"CustomerId");
        ...
        public static SqlDataAdapter OrderDataAdapter(SqlConnection sqlConnection)
        {
            ...
            insertCommand.Parameters.Add("@Price", SqlDbType.Decimal, sizeof(decimal), "Price");
            insertCommand.Parameters.Add("@Quantity", SqlDbType.Int, sizeof(int), "Quantity");
            insertCommand.Parameters.Add("@CustomerId", SqlDbType.Int, sizeof(int), "CustomerId");
            ...
            command.Parameters.Add("@Price", SqlDbType.Decimal, sizeof(decimal), "Price");
            command.Parameters.Add("@Quantity", SqlDbType.Int, sizeof(int), "Quantity");
            command.Parameters.Add("@CustomerId", SqlDbType.Int, sizeof(int), "CustomerId");
            ...
            parameter = command.Parameters.Add("@OrderId", SqlDbType.Int,sizeof(int),"OrderId");
            parameter.SourceVersion = DataRowVersion.Original;
