    ...
    public class Seed
    {
            ...
            if (!context.Partners.Any())
            {
                ...
                var Darwin = new Partner()
                {
                    ...
                    News = new List<News>()
                    {
                        ...
                        {
                            DateOfCreation = DateTime.Now,
                            Title="iPhone 12: все, что нужно знать о «укушенном яблоке» 2022 года",
                            Body = @"В последнее время было много слухов о выпуске последней модели iPhone и ее новых спецификаций. Мы собрали всю информацию, и вот краткое изложение того, что Apple готовит для нас в 2022 году. Новые и основные детали относятся к усовершенствованию новой системы распознавания лиц Face ID. Также говорят о количестве новых моделей и разнице между ними, и не в последнюю очередь, о производительности устройств с обновлением ОЗУ"
                        },
                        new News()
                        {
                            DateOfCreation = DateTime.Now,
                ...
                var Patria = new Partner()
                {
                    ...
                    News = new List<News>()
                    {
                        ...
                        {
                            DateOfCreation = DateTime.Now,
                            Title="Привет любителям попкорна и кино! Приглашаем вас ознакомиться с премьерами этой недели, показ которых мы начнем в Четверг, 12.03.2022",
                ...
                var fidesco = new Partner()
                {
                    ...
                    News = new List<News>()
                    {
                        ...
                        new News()
                        {
                            ...
                            Body = @" Сегодня, 24 марта 2022 года в 12:00, начал работу 33-й по счёту магазин сети FIDESCO. Это наш 20-й магазин FIDESCO в Кишинёве. Магазин расположен по адресу: Кишинёв, ул. И. Крянгэ, 5/2 и работает по графику: П-В с 8:00 до 22:00.",
                        }
                    },
                    Rating = (decimal)8.7
                };
                ...
                var customer = new Customer()
                {
                    ...
                    CustomersBalances = new List<CustomersBalance>()
                    {
                        ...
                        new CustomersBalance()
                        {
                            ...
                            ResetDate = new DateTime(2022,05,31)
                        },
                        new CustomersBalance()
                        {
                            Amount = 954,
                            ...
                            ResetDate = new DateTime(2022,06,20)
                        },
                        new CustomersBalance()
                        {
                            Amount = 2685,
        ...
        public static async Task SeedTransactions(DbCardContext context, ITransactionService transactionService, IFilialService filialService, ICustomerService customerService)
        {
            if (!context.Transactions.Any())
            {
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000012"), 500, new DateTime(2022, 5, 7));
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000000"), 219, new DateTime(2022, 3, 1));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000028"), 158, new DateTime(2022, 2, 14));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000007"), 825, new DateTime(2022, 4, 19));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000027"), 151, new DateTime(2022, 2, 17));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000046"), 1965, new DateTime(2022, 2, 1));
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000005"), 252, new DateTime(2022, 5, 5));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000006"), 25, new DateTime(2022, 2, 4));
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000049"), 151, new DateTime(2022, 2, 1));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000049"), 151, new DateTime(2022, 4, 7));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000045"), 157, new DateTime(2022, 2, 4));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000028"), 398, new DateTime(2022, 1, 2));
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000042"), 550, new DateTime(2022, 2, 19));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000005"), 458, new DateTime(2022, 4, 27));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000014"), 896, new DateTime(2022, 2, 17));
                ...
                await transactionService.CreateTransactionAsync(customer, await filialService.GetByPhoneAsync("100000030"), 151, new DateTime(2022, 1, 9));
