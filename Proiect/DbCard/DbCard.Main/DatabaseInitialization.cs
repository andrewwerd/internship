...
namespace dbCard.Main
{
    public static class DatabaseInitialization
    {
        ...
        {
            context.Set<Customer>().Add(new Customer { FirstName = "Adonis", LastName = "Allen", DateOfBirth = DateTime.Parse("04.08.1998"), Gender = "Male", UserId = context.Set<User>().ToList()[12].Id });
        ...
        {
            context.Set<Filial>().Add(new Filial { Address = new Address { Country = "Moldova", Street = "Burebista", City = "Chisinau", HouseNumber = "3", Region = "Chisinau" }, PhoneNumber = "068955458",PartnerId = context.Set<Partner>().ToList()[0].Id});
            ...
            context.Set<Filial>().Add(new Filial { Address = new Address { Country = "Moldova", Street = "Mesteru Manole", City = "Chisinau", HouseNumber = "4", Region = "Chisinau" }, PhoneNumber = "068738968", PartnerId = context.Set<Partner>().ToList()[1].Id });
            context.Set<Filial>().Add(new Filial { Address = new Address { Country = "Moldova", Street = "Scuterniceni", City = "Ungheni", HouseNumber = "5", Region = "Ungheni" }, PhoneNumber = "068042320", PartnerId = context.Set<Partner>().ToList()[2].Id });
            ...
            context.Set<Filial>().Add(new Filial { Address = new Address { Country = "Moldova", Street = "Stefan Cel Mare", City = "Ungheni", HouseNumber = "7", Region = "Ungheni" }, PhoneNumber = "068814218", PartnerId = context.Set<Partner>().ToList()[3].Id });
            context.Set<Filial>().Add(new Filial { Address = new Address { Country = "Moldova", Street = "Nationala", City = "Balti", HouseNumber = "87", Region = "Balti" }, PhoneNumber = "079488366", PartnerId = context.Set<Partner>().ToList()[4].Id });
            context.Set<Filial>().Add(new Filial { Address = new Address { Country = "Moldova", Street = "Dacia", City = "Chisinau", HouseNumber = "45", Region = "Chisinau" }, PhoneNumber = "079880065", PartnerId = context.Set<Partner>().ToList()[7].Id });
            context.Set<Filial>().Add(new Filial { Address = new Address { Country = "Moldova", Street = "Alexadru Ioan Cuza", City = "Chisinau", HouseNumber = "12", Region = "Chisinau" }, PhoneNumber = "079307066", PartnerId = context.Set<Partner>().ToList()[5].Id });
            ...
            context.Set<Filial>().Add(new Filial { Address = new Address { Country = "Moldova", Street = "Boico", City = "Ungheni", HouseNumber = "23", Region = "Ungheni" }, PhoneNumber = "079386166", PartnerId = context.Set<Partner>().ToList()[6].Id });
            ...
            context.Set<Filial>().Add(new Filial { Address = new Address { Country = "Moldova", Street = "Valea Crucei", City = "Chisinau", HouseNumber = "34/3", Region = "Chisinau" }, PhoneNumber = "079705389", PartnerId = context.Set<Partner>().ToList()[5].Id });
